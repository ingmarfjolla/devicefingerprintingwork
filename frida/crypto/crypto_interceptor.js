 ...
 ** https://github.com/noobpk/frida-android-hook/blob/master/frida-android-hook/frida-scripts/android-crypto-interceptor.js
 ***@@@---@@@@******************************************************************
 */
    ...
    if (Java.available) {
        ...
        Java.perform(function () {
            ...
            if (MODE.MessageDigest) {
                ...
                MessageDigest.update.overload('[B').implementation = function (input) {
                    console.log("[*] MessageDigest.update called with input (Base64): " + BASE64.getEncoder().encodeToString(input));
                    return this.update(input);
                };
            
                MessageDigest.digest.overload().implementation = function () {
                    var result = this.digest();
                    console.log("[*] MessageDigest.digest output (Base64): " + BASE64.getEncoder().encodeToString(result));
                    return result;
                };
